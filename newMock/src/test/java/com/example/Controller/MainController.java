...
public class MainController {
    ...
    private Logger log = (Logger) LoggerFactory.getLogger(MainController.class);
    ...
    public Object postBalances(@RequestBody RequestDTO requestDTO) {
        try {
            ...
            if (firstDigit == '8') {
                ...
                currency_type = "US";
                balance = BigDecimal.valueOf(random.nextFloat() * 2000);
            } else if (firstDigit == '9') {
                maxLimit = new BigDecimal(1000);
                currency_type = "EU";
                balance = BigDecimal.valueOf(random.nextFloat() * 1000);
            } else {
                maxLimit = new BigDecimal(10000);
                currency_type = "RUB";
                balance = BigDecimal.valueOf(random.nextFloat() * 10000);
            }
